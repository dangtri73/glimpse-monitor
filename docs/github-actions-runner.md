...
docker run --rm \
  ...
  -e REPORT_DOMAIN=report.hanwhafintech.com \
  -e REPORT_API_DOMAIN=report-api.hanwhafintech.com \
  -e API_RAG_RUNTIME_ST_DOMAIN=api-rag-runtime-st.hanwhafintech.com \
  -e H_Q1_DOMAIN=h-q1.hanwhafintech.com \
  -e H_ASSISTANT_PLAYGROUND_DOMAIN=h-assistant-playground.hanwhafintech.com \
  ...
  -e REPORT_UPSTREAM=http://192.0.2.10:3005 \
  -e REPORT_API_UPSTREAM=http://192.0.2.10:3004 \
  -e API_RAG_RUNTIME_ST_UPSTREAM=http://192.0.2.10:18000 \
  -e H_Q1_UPSTREAM=http://192.0.2.10:9000 \
  -e H_ASSISTANT_PLAYGROUND_UPSTREAM=http://192.0.2.10:18100 \
