...
trace_template_contract() {
  ...
  for var in TASK_DEV_DOMAIN TASK_DEV_API_DOMAIN TASK_PROD_DOMAIN TASK_PROD_API_DOMAIN REPORT_ST_DOMAIN REPORT_ST_API_DOMAIN H_Q1_DOMAIN EMBED_DOMAIN RERANK_DOMAIN MLX_DOMAIN MLX_CLASSIFY_DOMAIN; do
